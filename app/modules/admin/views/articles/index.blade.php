...
@section('content')
<div class="page-head">
    <h1><i class="fa fa-file-o"></i> {{ $title }}
                    ...
                    <table class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="button-column">
                                    <a class="btn btn-success btn-sm" href="{{ URL::route('admin.articles.create') }}">
                        ...
                        @foreach($pages as $page)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success btn-sm" href="{{ URL::route('admin.articles.show', $page->id) }}">
                                    ...
                                    {{ Form::open(array('method' => 'DELETE', 'route' => array('admin.articles.destroy', $page->id), 'class' => 'as-button')) }}
